...
7. Una sección "DESVIACIONES" donde listes, en prosa breve, cualquier punto donde el estado actual del repo difiera de lo que los ADRs en docs/decisions/ declaran. Si no hay ninguna, dilo en una línea.
